...
(Table 1). This is a benchmark census, not a
...
![Analysis architecture](docx-architecture.png)
...
Figure 2 and
Table 3 report the prespecified
outcomes.

![Quantitative figure](figure1-temporal-eligibility.png)
Contract existence at pre-incident landmarks. Error bars are
two-sided 95% Wilson intervals; counts use the fixed denominator <span
class="math inline"><em>N</em> = 417</span>.
...
![Quantitative figure](figure3-deployment-age-ecdf.png)
Empirical cumulative distribution of deployment-to-incident
...
![Quantitative figure](figure2-identity-sensitivity.png)
Sensitivity to the identity abstraction. Direct labels make
the result interpretable without color.
...
![Execution timeline](docx-timeline.png)
